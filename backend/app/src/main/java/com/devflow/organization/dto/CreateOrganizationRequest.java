...
/**
 * Data Transfer Object representing the {@code POST /api/v1/organizations} request body.
 *
 * <p>Captures the minimum required fields to create a new organization. Validation
 * constraints mirror those declared on {@link com.devflow.organization.domain.Organization}
 * so that invalid payloads are rejected at the HTTP layer before the service is invoked.
 *
 * <p>The owner is determined strictly from the authenticated security context — callers
